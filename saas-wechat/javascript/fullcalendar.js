					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (overrideText) {
                                ...
                                if (buttonName == 'prev') {
                                    innerHtml = "<span class='icon icon-arrow-left-border'></span>";
                                } else if (buttonName == 'next') {
                                    innerHtml = "<span class='icon icon-arrow-right-border'></span>";
                                } else {
                                ...
                                if (buttonName == 'month') {
                                    innerHtml = "<span class='icon icon-canlendar'></span>";
                                } else {
