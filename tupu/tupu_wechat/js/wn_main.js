(function(window,doc){
    ...
    function RESTFul(Pubsub,HashHandler){
        ...
        /**
         * 在所有主题被订阅之前，在页面首次加载之初
         * 初始化一个与源hash不同且暂未被订阅的主题
         * 最终仍然跳转到源hash
         * 此方法并不是必要的
         * @param {String} action
         * @param {Function} done
...
(function($) {
    ...
    function showModal() {
        $("#wn_form").submit();
        var str = '您已获得“' + $(".wn-wrapper li.active img").attr("alt") + '球迷”称号，现在您可以在跟贴中为您心爱的球队呐喊助威了！';
